...
export type ProductSortField = 'sku' | 'name' | 'category' | 'status';
export type ProductSortState = { field: ProductSortField; dir: 'asc' | 'desc' } | null;
...
export function ProductSortHeader({
  ...
  onSortClick: (field: ProductSortField) => void;
}) {
